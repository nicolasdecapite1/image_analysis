COLORS = {
    ...
    #'Brilliant orange': [0, 128, 0], [NaN, NaN, NaN]
    ...
    #'Vivid orange yellow': [255, 255, 0], [NaN, NaN, NaN]
    ...
    #'Deep olive green': [0, 128, 0], [NaN, NaN, NaN]
    ...
    #'Deep green': [0, 128, 0], [NaN, NaN, NaN]
    ...
    #'Deep bluish green': [0, 0, 128], [NaN, NaN, NaN]
    ...
    #'Vivid greenish blue': [0, 0, 128], [NaN, NaN, NaN]
    'Brilliant greenish blue': [45, 188, 226],
    'Strong greenish blue': [19, 133, 175],
    #'Deep greenish blue': [0, 0, 128], [NaN, NaN, NaN]
